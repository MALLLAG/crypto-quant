...
1. 동일 디렉토리에 `PLAN.md` 파일 생성
2. [PLAN.template.md](./PLAN.template.md) 템플릿을 기반으로 문서 작성
3. 각 단계별 체크리스트 포함
...
2. **점진적 상세화**: 처음부터 완벽할 필요 없음, 점진적으로 보완
3. **변경 추적**: 중요한 변경사항은 문서에 기록
4. **체크리스트 활용**: 구현 진행 상황을 체크리스트로 추적
5. **프로젝트 원칙 준수**: CLAUDE.md의 함수형 DDD 원칙 따르기
