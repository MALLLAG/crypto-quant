...
- [업비트 어시스턴트 이용 가이드](https://docs.upbit.com/kr/docs/assistant-guide.md): "업비트 어시스턴트"는 업비트 Open API 개발 문서를 보다 빠르고 효율적으로 탐색하고, 편리하게 이용할 수 있도록 지원합니다.
...
- [캔들 API로 지정한 기간의 시세 데이터를 CSV 파일로 출력하기](https://docs.upbit.com/kr/docs/how-to-download-candle-data.md): 업비트의 캔들 API로 지정한 기간의 캔들 데이터를 조회하여 CSV 파일로 출력하는 방법을 알아봅니다.
...
- [최근 체결 내역 조회](https://docs.upbit.com/kr/reference/recent-trades-history.md): 지정한 페어의 최근 체결 목록을 조회합니다.
...
- [주문 생성 테스트](https://docs.upbit.com/kr/reference/order-test.md): 실제 주문을 생성하지 않고 주문 요청 형식과 주문 가능 여부를 검증합니다.
...
- [호가 모아보기 단위 조회](https://docs.upbit.com/kr/reference/list-orderbook-levels.md): 종목별로 지원하는 모아보기 단위 목록을 조회합니다. 반환된 지원 단위를 호가 조회 API 사용 시 지정하여 호가를 원하는 단위로 조회할 수 있습니다.

## Changelog
- [[중요] 빙엑스(BingX) 계정주 확인 시 UUID 변경 안내(완료)](https://docs.upbit.com/kr/changelog/bingx_vasp_uuid_change.md)
- [[중요] 업비트 어시스턴트 점검 안내 (완료)](https://docs.upbit.com/kr/changelog/notice_upbit_assistanat_maintenance.md)
- [[안내] Websocket 현재가(Ticker) Deprecated 필드 삭제 안내(예정)](https://docs.upbit.com/kr/changelog/websocket-ticker-stream-deprecated-fields.md)
- [[안내] 업비트 개발자 센터 "AI 어시스턴트" 서비스 오픈 안내](https://docs.upbit.com/kr/changelog/assistant.md)
- [[안내] '주문 생성 테스트' 기능 추가(10/27)](https://docs.upbit.com/kr/changelog/order-test.md)